...
<form name="form1" enctype="multipart/form-data" method="post" action="save.asp">
...
<span title="文件大小不得大于10M">附　件：</span><input type="file" name="Afile" id="Afile" style="width:420px"  value="" title="文件大小不得大于10M"><br>
