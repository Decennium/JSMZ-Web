...
dstr+="</select>"
dstr+="<span style='padding:2px;margin:2px;background-color:#E5ECF9;cursor:pointer;' onclick=\"choose_date_czw('"+date_id+"','choose_date_czw_now')\">今日</span>"
dstr+="<span style='padding:2px;margin:2px;background-color:#C0C0C0;cursor:pointer;' onclick=\"choose_date_czw('choose_date_czw_close')\">关闭</span>";
...
dstr+="<table border='0' cellpadding='5' cellspacing='0'><tr bgcolor='#C0C0C0'><td>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td>六</td></tr>";
