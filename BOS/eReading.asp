...
Beizhu=htmlencode(Request.form("Beizhu"))
	...
	'		If Conn.State=adStateOpen Then Conn.Close
		...
		If MyRs.recordcount>0 then
			Response.Write "<script>document.getElementById('Tips').innerHTML = '今天的电子阅读已经登记。';</SCRIPT>"
		Else
...
<%If Session("Admin")<>"" then%>
<div align="left" style="clear:left;float:left;nowrap;width:200px;margin:5px 100px 5px 100px"><strong>添加电子阅读记录</strong></div>
<br clear="all"/>
...
<%End If%>
<div align="left" style="clear:left;float:left;nowrap;width:200px;margin:5px 100px 5px 100px"><strong>电子阅读情况一览表</strong></div>
<br clear="all"/>
...
response.write "<a href=""eReading.asp?page=1"">第一页</a> "
for i=StartPage to EndPage
	response.write "<a href=""eReading.asp?page=" & i & """>" & i & "</a> "
next 'i
response.write "<a href=""eReading.asp?page=" & PageCount & """>最后页</a> "
Else
...
set Conn=nothing
%>
<p align="left"><a href="download.asp?Action=ereading">下载电子阅读数据</a></p>
</div>
</div>
<br clear=all>
<br clear=all>
